...
class BusAttachment(AllJoynObject):
 ...
 u'EnablePeerSecurity': (u'alljoyn_busattachment_enablepeersecurity',
                         ...
                         ((u'alljoyn_busattachment', 'C.c_void_p'),
                          ...
                          (u'const char *', 'C.c_char_p'),
                          (u'int', 'C.c_int'))),
 u'EnablePeerSecurityWithPermissionConfigurationListener': (u'alljoyn_busattachment_enablepeersecuritywithpermissionconfigurationlistener',
                                                            (u'QStatus',
                                                             'C.c_uint'),
                                                            ((u'alljoyn_busattachment',
                                                              'C.c_void_p'),
 ...
 u'JoinSessionAsYNC': (u'alljoyn_busattachment_joinsessionasync',
                       ...
                       ((u'alljoyn_busattachment', 'C.c_void_p'),
                        ...
                        (u'alljoyn_busattachment_joinsessioncb_ptr',
                         'POINTER(BusAttachment.BusAttachmentJoinSessionCBFuncType)'),
                        (u'void *', 'C.c_void_p'))),
 ...
 u'SetLinkTimeoutAsYNC': (u'alljoyn_busattachment_setlinktimeoutasync',
                          ...
                          ((u'alljoyn_busattachment', 'C.c_void_p'),
                           ...
                           (u'alljoyn_busattachment_setlinktimeoutcb_ptr',
                            'POINTER(BusAttachment.BusAttachmentSetLinkTimeoutCBFuncType)'),
                           (u'void *', 'C.c_void_p'))),
 ...
 u'WhoImplementsInterfaces': (u'alljoyn_busattachment_whoimplements_interfaces',
    ...
    def JoinSession(self, sessionHost,sessionPort,listener,sessionId,opts):
        return self._JoinSession(self.handle,sessionHost,sessionPort,listener,sessionId,opts) # const char *,int,int,int *,int

    def JoinSessionAsYNC(self, sessionHost,sessionPort,listener,opts,callback,context):
        return self._JoinSessionAsYNC(self.handle,sessionHost,sessionPort,listener,opts,callback,context) # const char *,int,int,const int,alljoyn_busattachment_joinsessioncb_ptr,void *
    ...
    def EnablePeerSecurity(self, authMechanisms,listener,keyStoreFileName,isShared):
        return self._EnablePeerSecurity(self.handle,authMechanisms,listener,keyStoreFileName,isShared) # const char *,int,const char *,int

    def EnablePeerSecurityWithPermissionConfigurationListener(self, authMechanisms,authListener,keyStoreFileName,isShared,permissionConfigurationListener):
        return self._EnablePeerSecurityWithPermissionConfigurationListener(self.handle,authMechanisms,authListener,keyStoreFileName,isShared,permissionConfigurationListener) # const char *,int,const char *,int,int
    ...
    def RegisterSignalHandlerWithRule(self, signal_handler,member,matchRule):
        return self._RegisterSignalHandlerWithRule(self.handle,signal_handler,member,matchRule) # int,const int,const char *
    ...
    def UNREGISTERSIGNALHANDLERWITHRULE(self, signal_handler,member,matchRule):
        return self._UNREGISTERSIGNALHANDLERWITHRULE(self.handle,signal_handler,member,matchRule) # int,const int,const char *
    ...
    def AddLogOnEntry(self, authMechanism,userName,password):
        return self._AddLogOnEntry(self.handle,authMechanism,userName,password) # const char *,const char *,const char *
    ...
    def SetLinkTimeoutAsYNC(self, sessionid,linkTimeout,callback,context):
        return self._SetLinkTimeoutAsYNC(self.handle,sessionid,linkTimeout,callback,context) # int,int,alljoyn_busattachment_setlinktimeoutcb_ptr,void *
    ...
    def CancelWhoImplementsInterfaces(self, implementsInterfaces,numberInterfaces):
        return self._CancelWhoImplementsInterfaces(self.handle,implementsInterfaces,numberInterfaces) # const char **,int
