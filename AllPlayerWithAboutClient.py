...
if __name__ == "__main__":
    ...
    for bus_name, device_name, device_id in aboutListener.devices:
        allplayers.append(
            AllPlayer(g_bus, bus_name, MyAboutListener.session_id, device_name, device_id))
